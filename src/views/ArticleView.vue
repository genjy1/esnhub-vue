...
<template>
  <main class="w-4/5 mx-auto my-0 py-4 px-4 font-display">
    <div
      class="wrapper w-80 md:w-5/6 mx-auto my-0 flex flex-col text-white bg-zinc-800 p-4 rounded-xl"
    >
    ...
    <div class="form-wrapper md:w-5/6 mx-auto my-0 mt-4 text-white">
      <h3>Комментарии</h3>
